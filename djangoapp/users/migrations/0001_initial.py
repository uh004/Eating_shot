    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', models.CharField(blank=True, choices=[('chronic_disease', '만성질환'), ('healthy_diet', '건강한 식습관, 체중 감량')], max_length=20, null=True)),
                ('health_conditions', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('exercise_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.exercisetype')),
            ],
        ),
        migrations.CreateModel(
            name='HbA1c',
